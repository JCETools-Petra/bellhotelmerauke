                            ...
                            <tr>
                                <td class="py-3 px-4">
                                    @if ($commission->booking_id)
                                        <div class="fw-bold text-dark">Booking ID #{{ $commission->booking_id }}</div>
                                ...
                                <td class="py-3 px-4">
                                    <span class="badge {{ $commission->status == 'paid' ? 'bg-success-soft text-success' : 'bg-warning-soft text-warning' }}">
